...
### Overview
Add a prompt-mini legend to the concept section of ALL 108 framework pages. The legend is a compact visual inside the blue highlight-box showing each framework component as a circular badge + label + short definition. Format approved on `learn/crisp.html`.
...
- **Step-based (104 remaining):** Each step gets a badge (number or icon), label, and short definition

### Scope
- 108 framework pages included (all with 13-section template)
- 9 pages excluded (7 category pages + 2 hub pages — no concept section)
