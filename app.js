...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const ethicsTickerMessages = [
        'GPT-4 scored 90th percentile on the bar exam -- but still invents fake case citations. Always verify.',
        '48 US states now have AI transparency laws on the books. Do you know yours?',
        'One biased training dataset can deny thousands of people loans, jobs, or housing. Audit your data.',
        'AI does not understand truth -- it predicts the next likely word. The difference matters.',
        'A single deepfake video can crash a stock price in minutes. Verify before you believe.',
        'Training GPT-3 consumed enough energy to power a US home for 120 years. Use AI thoughtfully.',
        'Humans who blindly trust AI recommendations perform worse than humans who question them.',
        'The person who deploys the AI is accountable for its output -- not the model.',
        'AI hiring tools have been caught penalizing resumes that mention "women" -- bias testing is not optional.',
        'ChatGPT gained 100 million users in 2 months. Regulation moves slower -- your judgment fills the gap.',
        'Healthcare AI misdiagnoses darker skin tones at 2-3x higher rates. Fairness requires active testing.',
        'An AI-generated image won an art competition. The judges had no idea. Disclosure builds trust.',
        'Students using AI without verification score lower on follow-up tests. Understanding beats shortcuts.',
        '77% of consumers want to know when they are interacting with AI. Transparency is not a feature -- it is a right.',
        'AI can generate 1,000 phishing emails per second. Your critical thinking is the last line of defense.',
        'The EU AI Act classifies high-risk systems by harm potential. Know the risk level of your tools.',
        'Confidential data entered into AI chatbots has appeared in other users\' responses. Guard your inputs.',
        'AI models trained on the internet inherit the internet\'s worst biases. Question every output.',
        'Autonomous weapons, mass surveillance, social scoring -- the line between use and misuse is drawn by people.',
        'Open-source AI enables transparency but also lowers the barrier for misuse. Openness needs guardrails.',
        'AI image generators trained on copyrighted art without consent sparked a global legal reckoning.',
        'Voice cloning needs only 3 seconds of audio to impersonate someone. Consent is non-negotiable.',
        'When AI gets it wrong in medicine, someone can die. Human oversight is not bureaucracy -- it is a safeguard.',
        'The best prompt engineers are not the cleverest -- they are the most responsible.',
        'AI wrote 25% of Google\'s new code in 2024. Who reviews the code the AI writes? You do.',
        'Retrieval-augmented generation reduces hallucinations -- but does not eliminate them. Still verify.',
        'AI literacy is the new digital literacy. If you cannot question it, you cannot safely use it.',
        'Every AI system encodes someone\'s values. Ask whose values -- and who was left out of the conversation.'
    ];
